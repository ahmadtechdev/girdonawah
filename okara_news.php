...
// Fetch Okara news articles from the database
$sql = "SELECT * FROM articles WHERE category = 'okara' ORDER BY publish_date DESC";
...
<head>
    ...
    <title>اوکاڑہ کی خبریں - گردونواح</title>
...
<body>
    ...
    <!-- Page Title -->
    <h2 class="page-title">اوکاڑہ کی خبریں</h2>
